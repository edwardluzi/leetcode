...
extern void test(string* board, int boardSize, string* word, int wordSize, string* expected, int expectedSize);

#pragma warning(suppress: 6262)
void test3()
{
	string bs[] = { "aaaa", "aaaa", "aaaa", "aaaa", "bcde", "fghi", "jklm", "nopq", "rstu", "vwxy", "zzzz" };
	string ws[] = {
	...
	string ex[] = {
			"aaaaaaaaaaaaaaaa", "aaaaaaaaaaaaaaab", "aaaaaaaaaaaaaaac", "aaaaaaaaaaaaaaad", "aaaaaaaaaaaaaaae",
			"aaaaaaaaaaaaaabc", "aaaaaaaaaaaaaabf", "aaaaaaaaaaaaaacb", "aaaaaaaaaaaaaacd", "aaaaaaaaaaaaaacg",
			"aaaaaaaaaaaaaadc", "aaaaaaaaaaaaaade", "aaaaaaaaaaaaaadh", "aaaaaaaaaaaaaaed", "aaaaaaaaaaaaaaei" };
